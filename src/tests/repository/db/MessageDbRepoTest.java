...
class MessageDbRepoTest {
    ...
    void setUp() {
        ...
        MessageRepo repoM=new MessageDbRepo("jdbc:postgresql://localhost:5432/TestReteaDeSocializare","postgres","852456");
    ...
    @AfterEach
    void tearDown() {
        MessageDbRepo repoM=new MessageDbRepo("jdbc:postgresql://localhost:5432/TestReteaDeSocializare","postgres","852456");
